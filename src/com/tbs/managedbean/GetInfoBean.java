...
//	TourPackageFacade tourPackageFacade;
	...
	public void init(){
		...
		filteredTravellers = new ArrayList();
		try{
			for(TourSales tourSales : getInfoFacade.getAllTourSales()){
				filteredPackages.add(tourSales.getTourPackage());
				filteredTravellers.add(tourSales.getTraveller());
			}
