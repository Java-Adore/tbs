...
public class RegisterationBean implements Serializable {
	...
	public void register() {
		...
		try {
			...
			Member member = memeberService.register(firstName, lastName, email, password,
	...
	private String saveFileIfExist() throws TBSException {
	...
	private void validatePasswords() throws TBSException {

		if (!password.equals(confirmPass)) {
			throw new TBSException(
