...
public class Util {
	...
	public static boolean isDateBetween(Date date,
	...
	public static <T extends Marker> T extractMarkerFromList(List<T> list , T marked)
	{
	...
	public static <T extends Marker> T extractMarkerFromList(List<T> list , Long ID)
	{
		for(Marker currentMarkedObject : list)
		{
